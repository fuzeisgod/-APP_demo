	...
	<view>
		<uni-popup ref="popup" type="bottom">
			...
			<view class="flex align-center">
				<view class="flex-1 flex flex-column align-center justify-center py-2" hover-class="bg-light" v-for="(item, index) in providerList"
				 :key="index" @tap="share(item)">
					<view class="rounded-circle iconfont text-white flex align-center justify-center font-lg" style="height: 100rpx;width: 100rpx;"
