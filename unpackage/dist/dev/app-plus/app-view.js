...
var x=['./components/common/common-list.wxml','./components/common/divider.wxml','./components/common/load-more.wxml','./components/common/no-thing.wxml','./components/common/upload-image.wxml','./components/uni-ui/uni-icons/uni-icons.wxml','./components/uni-ui/uni-nav-bar/uni-nav-bar.wxml','./components/uni-ui/uni-status-bar/uni-status-bar.wxml','./pages/add-input/add-input.wxml','./pages/demo/demo.wxml','./pages/index/index.wxml','./pages/msg/msg.wxml','./pages/my/my.wxml','./pages/news/news.wxml','./pages/search/search.wxml'];d_[x[0]]={}
...
var z=gz$gwx_9()
var c9C=_n('view')
var o0C=_mz(z,'uni-nav-bar',['bind:__l',0,'bind:clickLeft',1,'border',1,'data-event-opts',2,'leftIcon',3,'statusBar',4,'vueId',5,'vueSlots',6],[],e,s,gg)
var lAD=_n('view')
...
_(o0C,lAD)
_(c9C,o0C)
var eDD=_mz(z,'textarea',['bindinput',11,'class',1,'data-event-opts',2,'placeholder',3,'value',4],[],e,s,gg)
_(c9C,eDD)
var bED=_mz(z,'upload-image',['bind:__l',16,'bind:change',1,'class',2,'data-event-opts',3,'data-ref',4,'list',5,'show',6,'vueId',7],[],e,s,gg)
_(c9C,bED)
var oFD=_mz(z,'view',['class',24,'style',1],[],e,s,gg)
var xGD=_mz(z,'view',['class',26,'hoverClass',1],[],e,s,gg)
_(oFD,xGD)
var oHD=_mz(z,'view',['class',28,'hoverClass',1],[],e,s,gg)
_(oFD,oHD)
var fID=_mz(z,'view',['bindtap',30,'class',1,'data-event-opts',2,'hoverClass',3],[],e,s,gg)
_(oFD,fID)
var cJD=_mz(z,'view',['class',34,'hoverClass',1,'style',2],[],e,s,gg)
var hKD=_oz(z,37,e,s,gg)
_(cJD,hKD)
_(oFD,cJD)
_(c9C,oFD)
_(r,c9C)
...
_(oND,lOD)
_(cMD,oND)
var aPD=_mz(z,'button',['bindtap',2,'data-event-opts',1,'type',2],[],e,s,gg)
...
var z=gz$gwx_11()
var bSD=_n('view')
var oTD=_mz(z,'scroll-view',['scrollWithAnimation',-1,'scrollX',-1,'class',0,'scrollIntoView',1,'style',1],[],e,s,gg)
var xUD=_v()
_(oTD,xUD)
var oVD=function(cXD,fWD,hYD,gg){
var c1D=_mz(z,'view',['bindtap',7,'class',1,'data-event-opts',2,'id',3],[],cXD,fWD,gg)
var o2D=_oz(z,11,cXD,fWD,gg)
_(c1D,o2D)
_(hYD,c1D)
return hYD
}
xUD.wxXCkey=2
_2z(z,5,oVD,e,s,gg,xUD,'item','index','index')
_(bSD,oTD)
var l3D=_mz(z,'swiper',['bindchange',12,'current',1,'data-event-opts',2,'duration',3,'style',4],[],e,s,gg)
var a4D=_v()
_(l3D,a4D)
var t5D=function(b7D,e6D,o8D,gg){
var o0D=_n('swiper-item')
var fAE=_mz(z,'scroll-view',['bindscrolltolower',21,'data-event-opts',1,'scrollY',2,'style',3],[],b7D,e6D,gg)
var cBE=_v()
_(fAE,cBE)
if(_oz(z,25,b7D,e6D,gg)){cBE.wxVkey=1
var hCE=_v()
_(cBE,hCE)
var oDE=function(oFE,cEE,lGE,gg){
var tIE=_mz(z,'common-list',['bind:__l',30,'bind:doSupport',1,'bind:follow',2,'data-event-opts',3,'index',4,'item',5,'vueId',6],[],oFE,cEE,gg)
_(lGE,tIE)
var eJE=_mz(z,'divider',['bind:__l',37,'vueId',1],[],oFE,cEE,gg)
_(lGE,eJE)
return lGE
}
hCE.wxXCkey=4
_2z(z,28,oDE,b7D,e6D,gg,hCE,'item2','index2','index2')
var bKE=_mz(z,'load-more',['bind:__l',39,'loadmore',1,'vueId',2],[],b7D,e6D,gg)
_(cBE,bKE)
}
else{cBE.wxVkey=2
var oLE=_mz(z,'no-thing',['bind:__l',42,'vueId',1],[],b7D,e6D,gg)
_(cBE,oLE)
}
cBE.wxXCkey=1
cBE.wxXCkey=3
...
a4D.wxXCkey=4
_2z(z,19,t5D,e,s,gg,a4D,'item','index','index')
_(bSD,l3D)
_(r,bSD)
return r
}
...
var z=gz$gwx_14()
var oTE=_n('view')
var lUE=_mz(z,'uni-nav-bar',['fixed',-1,'statusBar',-1,'bind:__l',0,'bind:clickRight',1,'border',1,'data-event-opts',2,'vueId',3,'vueSlots',4],[],e,s,gg)
var aVE=_n('view')
_rz(z,aVE,'class',6,e,s,gg)
var tWE=_v()
_(aVE,tWE)
var eXE=function(oZE,bYE,x1E,gg){
var f3E=_mz(z,'view',['bindtap',11,'class',1,'data-event-opts',2],[],oZE,bYE,gg)
var c4E=_oz(z,14,oZE,bYE,gg)
_(f3E,c4E)
_(x1E,f3E)
return x1E
}
tWE.wxXCkey=2
_2z(z,9,eXE,e,s,gg,tWE,'item','index','index')
_(lUE,aVE)
var h5E=_mz(z,'text',['class',15,'slot',1],[],e,s,gg)
_(lUE,h5E)
_(oTE,lUE)
var o6E=_mz(z,'swiper',['bindchange',17,'current',1,'data-event-opts',2,'duration',3,'style',4],[],e,s,gg)
var c7E=_n('swiper-item')
var o8E=_mz(z,'scroll-view',['scrollY',22,'style',1],[],e,s,gg)
var l9E=_v()
_(o8E,l9E)
var a0E=function(eBF,tAF,bCF,gg){
var xEF=_mz(z,'common-list',['bind:__l',28,'bind:doSupport',1,'bind:follow',2,'data-event-opts',3,'index',4,'item',5,'vueId',6],[],eBF,tAF,gg)
_(bCF,xEF)
var oFF=_mz(z,'divider',['bind:__l',35,'vueId',1],[],eBF,tAF,gg)
_(bCF,oFF)
return bCF
}
l9E.wxXCkey=4
_2z(z,26,a0E,e,s,gg,l9E,'item','index','index')
_(c7E,o8E)
_(o6E,c7E)
var fGF=_n('swiper-item')
var cHF=_mz(z,'scroll-view',['scrollY',37,'style',1],[],e,s,gg)
var hIF=_n('view')
...
var hWF=_mz(z,'view',['bindtap',8,'class',1,'data-event-opts',2,'hoverClass',3],[],oTF,xSF,gg)
var oXF=_oz(z,12,oTF,xSF,gg)
_(hWF,oXF)
_(fUF,hWF)
return fUF
}
bQF.wxXCkey=2
_2z(z,6,oRF,e,s,gg,bQF,'item','index','index')
_(lMF,ePF)
}
else{lMF.wxVkey=2
var cYF=_v()
...
var b5F=_mz(z,'common-list',['bind:__l',17,'index',1,'item',2,'vueId',3],[],a2F,l1F,gg)
_(t3F,b5F)
return t3F
}
cYF.wxXCkey=4
_2z(z,15,oZF,e,s,gg,cYF,'item','index','index')
}
lMF.wxXCkey=1
lMF.wxXCkey=3
_(r,oLF)
...
__wxAppCode__['pages/news/news.wxss']=setCssToHead([".",[1],"support-active { color: #FF4A6A; }\n",],undefined,{path:"./pages/news/news.wxss"});    
